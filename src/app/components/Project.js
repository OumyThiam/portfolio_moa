...
export default ({ id }, t) => {
    const { hasImage, techs: projectTech, links, image } = projects.find(
    ...
    return /*html*/ `
        <div class="project">
            ${
                hasImage
                    ? `<img src="/images/projects/${image}" alt="${t[id].name}" class="project__image" style="width:100%; height:auto; object-fit:cover;" />
`
                    : ""
            }
